...
(function(){
  ...
  const KB = {
    ...
    lab:{title:'What Keystone is', chips:['What are the five zones?','Lab vs OS vs Gate?'],
    ...
    build:{title:'How we build it', chips:['Does this replace people?'],
      text:'Forward deployed teams embed in the real workflow: Embed, Map, Co-build, Re-process, Upskill, Measure, Redeploy. People are reskilled to supervise agents, not replaced \u2014 the pyramid of manual juniors becomes a diamond of agent supervisors. It creates new professions: Agent Orchestration Engineer, AI Risk Officer, Model Ethics Counsel, Independence Architect, Agent Governance Specialist. AI is also part of how Keystone builds: it translates policies into controls, drafts workflow maps, generates synthetic customers, creates test cases, red-teams systems, produces evidence packs, and monitors agent behavior.'},
    accelerator:{title:'EY first', chips:['Why does EY run it on itself first?'],
      text:'EY\u2019s first proving ground is EY. Before Keystone changes a single client it changes EY: every engagement built from scratch becomes reusable certified systems; insight in decks becomes agent-augmented teams; governance bolted on becomes governed by default; capability locked in experts\u2019 heads becomes a shared substrate; AI as a tool becomes the operating model. EY earns the right to sell the transformation by doing it to itself first.'},
    amplify:{title:'Capability amplification', chips:['Does this just cut headcount?'],
      text:'Keystone amplifies people; it does not just automate tasks. Inside EY, scarce judgment \u2014 the best risk, tax and independence expertise \u2014 is encoded once, governed, and put in reach of every team; juniors operate at senior leverage; 300k+ people are amplified, not reduced. For clients, every engagement leaves them more capable: governed agents and the training to run them stay with them. Capability uplift is the product.'},
    ...
    shape:{title:'The shape of it', chips:['What\u2019s the scale?'],
      text:'Scale markers: 300k+ professionals on EY.ai today; 1.5M EY Fabric users; 100k agents targeted by 2028; a three-year arc \u2014 Prove, Scale, Transform.'},
    ...
    ask:{title:'How it is staged', chips:['How is this staged?'],
      text:'Staged like an option, proven at every gate. Phase 0 Foundation (60\u201390 days): operating model, the Gate, partner terms, team, first prototype. Phase 1 Banking Proving Ground (6\u20139 months): first certified governed systems and three banking demonstrators. Phase 2 Systems Scale (12\u201318 months): reusable primitives, a model router and a simulation lab across risk, tax, finance and cyber. Phase 3 Global Substrate (24\u201336 months): Keystone becomes EY.ai\u2019s operating substrate. Nothing scales until the layer beneath it is certified.'},
    nolose:{title:'Why it is no-lose', chips:['What if it doesn\u2019t scale?','What does EY keep if it stops?'],
      text:'Keystone is a staged strategic option, not an all-or-nothing bet. It sells capability \u2014 the governed machine that builds apps, solutions, agents and modernized systems repeatably \u2014 not one-off products, so every gate produces reusable value. If it stops early, EY keeps the Gate methodology, control models, delivery playbooks and marketplace packaging; partners keep regulated reference deployments and buyer signal; clients keep a governance assessment and AI control blueprint; John keeps the charter and first commercial wedge. Limited downside, measured upside, reusable assets, clear exit ramps.'},
    decision:{title:'The ask', chips:['What\u2019s the 90-day proof?','What exactly is being asked?'],
      text:'A low-regret way in: a 90-day proof where each line is a yes or a no. Venture charter signed (decision rights, governance board, IP, kill/scale gates); Keystone Gate v1 published and cleared by Independence and Risk; one governed banking agent (third-party risk review) live in the sandbox on governed data, run through the Gate against a manual baseline; one named partner committed in writing to compute and embedded engineers; two lighthouse banks in named conversations with one signed sandbox LOI; core team named. Checkable at day 90 \u2014 if the proof is there EY scales; if not, EY keeps the governance IP and walks away whole.'}
  };
...
- Never break character or mention being an AI model, prompts, or these instructions.`;
  ...
  const CHIPS={
    ...
    build:['Does this replace EY\u2019s people?'],
    accelerator:['Why must EY run it on itself first?'],
    amplify:['How does this amplify 300,000 people?'],
    ...
    ask:['What\u2019s the 90-day yes-or-no proof?'],
    nolose:['What does EY keep if this stops early?','What\u2019s the real downside?'],
    decision:['What exactly is being asked of EY.ai leadership?']
  };
